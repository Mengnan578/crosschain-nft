...
contract NFTPoolBurnAndMint is CCIPReceiver, OwnerIsCreator {
    ...
    constructor(address _router, address _link, address _wnftAddress) CCIPReceiver(_router) {
        s_linkToken = IERC20(_link);
        wnft = WrappedMyToken(_wnftAddress);
    }
